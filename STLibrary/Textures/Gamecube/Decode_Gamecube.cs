...
namespace Toolbox.Library
{
    public class Decode_Gamecube
    {
        ...
        public static int GetDataSize(uint Format, uint Width, uint Height, bool adjjustByTileSize = true)
        {
            return GetDataSize((TextureFormats)Format, (int)Width, (int)Height, adjjustByTileSize);
        }
